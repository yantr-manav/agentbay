...
INSERT INTO public.subscription_plans (id, name, description, price_usd_monthly, price_usd_yearly, price_inr_monthly, price_inr_yearly, features, max_hours_monthly) VALUES
('basic', 'Basic', 'Perfect for getting started with AI agents', 9.99, 99.99, 799.00, 7999.00, '["Up to 10 hours per month", "Basic AI agents", "Standard support", "Basic analytics"]', 10),
('premium', 'Premium', 'Best for regular users and small teams', 29.99, 299.99, 2499.00, 24999.00, '["Up to 50 hours per month", "Premium AI agents", "Priority support", "Advanced analytics", "Custom integrations"]', 50),
('enterprise', 'Enterprise', 'For large teams and organizations', 99.99, 999.99, 8499.00, 84999.00, '["Unlimited hours", "All AI agents", "Dedicated support", "Advanced analytics", "Custom agents", "API access"]', NULL);
